...
#define PHYS_OFFSET		UL(0x04000000)
#elif defined(CONFIG_ARCH_MSM7630) && (defined(CONFIG_MACH_VIVOW) || defined(CONFIG_MACH_EXPRESS) || defined(CONFIG_MACH_KINGDOM) || defined(CONFIG_MACH_TAGH) || defined(CONFIG_MACH_EXPRESS_H) || defined(CONFIG_MACH_BLISSC))
